...
int main()
{
	...
	ft_printf("\n%.f|%.1f|%.2f|%.5f|%.120f", 0.000099, 0.000099, 0.000099, 0.000099, 0.000099);
	   printf("\n%.f|%.1f|%.2f|%.5f|%.120f", 0.000099, 0.000099, 0.000099, 0.000099, 0.000099);
	// ft_printf("\n%f|%-f|%+f|% f|%#f|%0f", DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN);
	//    ft_printf("\n%.f|%.1f|%.2f|%.5f|%.12f", 899.9999999, 899.9999999, 899.9999999, 899.9999999, 899.9999999);
	//       printf("\n%.f|%.1f|%.2f|%.5f|%.12f", 899.9999999, 899.9999999, 899.9999999, 899.9999999, 899.9999999);
	// ft_printf("%+08.2f", -0.);
